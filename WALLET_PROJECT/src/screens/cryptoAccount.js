...
import { colors, contentColor, geckoNative, geckoTokens, native, NetworkName, NODE_ENV_NETWORK_RCP, tokens, tokensContracts, tokensIcons } from "../../env"
                            ...
                            <ScrollView persistentScrollbar>
                                <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                                    <View style={{ width: "33.33%" }}>
                                        {
                                            this.context.value.show ? <Image source={acala} style={{ width: 20, height: 20, alignSelf: 'center' }} /> : <Text style={{ fontSize: 20, color: 'white', alignSelf: 'center' }}>{"***"} </Text>
                                        }
                                    </View>
