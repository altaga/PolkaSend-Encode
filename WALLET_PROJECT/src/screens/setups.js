        ...
        return (
            <View style={GlobalStyles.containerSetup}>
                ...
                }
                {
                    this.state.stage === 0 &&
                    <>
                        <Image source={logoETH} style={{ width: Dimensions.get("screen").width * 0.8 }} resizeMode="contain" />
                    </>
                }
                {
                    this.state.stage === 1 &&
                    <>
                        ...
                        <Image source={logoETH} style={{ height: Dimensions.get("screen").height * 0.3 }} resizeMode="contain" />
